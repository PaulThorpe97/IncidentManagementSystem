...
namespace FrontEnd
{
    public partial class AdministratorIncidentScreen : System.Web.UI.Page
    {
        ...
        protected void btnAddNewIncident_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("AdministratorAddNewIncidentScreen.aspx");
        }
        ...
        protected void btnDeleteIncidentDetails_Click(object sender, EventArgs e)
        {
            ...
            if (lstIncidents.SelectedIndex != -1)
            {
                ...
                Response.Redirect("AdministratorDeleteIncidentScreen.aspx");
            }
            else //if no record has been selected 
            {
                //display an error
