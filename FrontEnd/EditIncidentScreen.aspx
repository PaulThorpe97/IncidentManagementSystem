...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p>
        <span style="text-decoration: underline; font-size: large;"><strong><em>Edit Incident Screen</em></strong></span><span style="font-size: x-large;">&nbsp;&nbsp;&nbsp;&nbsp; <strong><em>
    <asp:Button ID="btnEditHome" runat="server" style="font-weight: bold" Text="Home" />
        </em></strong></span>
    ...
    <hr>
    <p>
        <span style="color: #CC0000">Incident ID:
    ...
    <br />
    <asp:TextBox ID="txtEditIncidentDescription" runat="server" Height="78px" Width="637px"></asp:TextBox>
    <br />
    </strong></em></span>
    <hr>
    ...
    <br />
    *Staff ID:<asp:TextBox ID="txtCommentStaffID" runat="server"></asp:TextBox>
    <strong>&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp; </strong>
    <asp:TextBox ID="txtComments" runat="server" Height="43px" Width="704px"></asp:TextBox>
    <asp:ListBox ID="lstCommentsHistory" runat="server" Height="151px" Width="818px"></asp:ListBox>
</asp:Content>
